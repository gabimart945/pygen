...
describe('PetForm Component Tests', () => {
    ...
    it('updates form fields correctly', () => {
        ...
        const input2 = screen.getByLabelText(/birth_date/i);
        fireEvent.change(input2, {
            target: {
                value: "2023-01-01"
            }
        });
        expect(input2.value).toBe("2023-01-01");
    ...
    it('submits the form with correct data', async () => {
        ...
        render(<PetForm onSuccess={mockOnSuccess} />);
    ...
    it('handles update correctly', async () => {
        ...
        render(<PetForm id={1} onSuccess={mockOnSuccess} />);
