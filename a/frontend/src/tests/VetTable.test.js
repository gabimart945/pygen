...
describe('VetTable Component Tests', () => {
    ...
    it('triggers onEdit callback when Edit is clicked', () => {
        ...
        render(<VetTable data={mockData} onEdit={mockEdit} />);
    ...
    it('triggers onDelete callback when Delete is clicked', () => {
        ...
        render(<VetTable data={mockData} onDelete={mockDelete} />);
    ...
    it('triggers onSelect callback when a row is clicked', () => {
        ...
        render(<VetTable data={mockData} onSelect={mockSelect} />);
