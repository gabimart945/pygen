  ...
  const handleDeleteRelated = (entity, itemId) => {
    api
      ...
      .then(() => {
        ...
        if (currentItem) {
          api.get(`/vets/${currentItem.id}/${entity.toLowerCase()}s`)
             .then((resp) => {
                setRelatedData((prev) => ({
                    ...prev,
    ...
    const handleRelatedFormSuccess = () => {
        ...
        if (currentItem) {
            ...
            api.get(`/vets/${currentItem.id}/visits`)
               .then((response) => {
                   setRelatedData((prev) => ({
                       ...prev,
                       'visit': response.data,
