...
const VisitForm = ({
    ...
    useEffect(() => {
        ...
        const fetchDropdownOptions = async () => {
            ...
            for (const rel of [{"target": "Pet", "type": "ParentReferenceComponent"}, {"target": "Vet", "type": "ParentReferenceComponent"}]) {
    ...
    const fields = [{"name": "visit_date", "type": "date"}, {"name": "description", "type": "text"}];
    const relationships = [{"target": "Pet", "type": "ParentReferenceComponent"}, {"target": "Vet", "type": "ParentReferenceComponent"}];
