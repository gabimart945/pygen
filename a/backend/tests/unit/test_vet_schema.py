...
class TestVetSchema(unittest.TestCase):
    """
    Unit test class for the VetSchema.

    This class tests the functionality of the VetSchema, including data validation,
